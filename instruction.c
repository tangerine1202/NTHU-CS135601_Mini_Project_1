...
void MOV_REG_REG(Register *reg1, Register *reg2, int debug)
{
    if (debug)
...
void MOV_REG_INT(Register *reg1, int val, int debug)
{
    if (debug)
...
void MOV_REG_ADDR(Register *reg1, int addr2, char *addrname, int addrval, int debug)
{
    if (debug)
...
void MOV_ADDR_REG(int addr1, Register *reg2, char *addrname, int addrval, int debug)
{
    if (debug)
...
void ADD_REG_REG(Register *reg1, Register *reg2, int debug)
{
    if (debug)
        printf("ADD %s(%d)\t%s(%d)\n", reg1->name, reg1->val, reg2->name, reg2->val);
    else
...
void SUB_REG_REG(Register *reg1, Register *reg2, int debug)
{
    if (debug)
        printf("SUB %s(%d)\t%s(%d)\n", reg1->name, reg1->val, reg2->name, reg2->val);
    else
...
void MUL_REG_REG(Register *reg1, Register *reg2, int debug)
{
    if (debug)
        printf("MUL %s(%d)\t%s(%d)\n", reg1->name, reg1->val, reg2->name, reg2->val);
    else
...
void DIV_REG_REG(Register *reg1, Register *reg2, int debug)
{
    if (debug)
        printf("DIV %s(%d)\t%s(%d)\n", reg1->name, reg1->val, reg2->name, reg2->val);
    else
...
void OR_REG_REG(Register *reg1, Register *reg2, int debug)
{
    if (debug)
        printf("OR %s(%d)\t%s(%d)\n", reg1->name, reg1->val, reg2->name, reg2->val);
    else
...
void AND_REG_REG(Register *reg1, Register *reg2, int debug)
{
    if (debug)
        printf("AND %s(%d)\t%s(%d)\n", reg1->name, reg1->val, reg2->name, reg2->val);
    else
...
void XOR_REG_REG(Register *reg1, Register *reg2, int debug)
{
    if (debug)
        printf("XOR %s(%d)\t%s(%d)\n", reg1->name, reg1->val, reg2->name, reg2->val);
    else
